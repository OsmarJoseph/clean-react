...
type SutTypes = {
  ...
  httpPostClientSpy: HttpPostClientSpy<{ParamTypes: {Body: Authentication.Params}}>
  mockUrl: string

}

const makeSut = (): SutTypes => {
  const httpPostClientSpy = new HttpPostClientSpy<{ParamTypes: {Body: Authentication.Params}}>()
